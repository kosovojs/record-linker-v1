...
class TestPaginatedResponse:
    ...
    def test_has_next_prev(self):
        ...
        response = PaginatedResponse[str](
            items=["a"], total=50, page=1, page_size=20, has_more=True
        )
        ...
        response2 = PaginatedResponse[str](
            items=["a"], total=50, page=2, page_size=20, has_more=True
        )
        ...
        response3 = PaginatedResponse[str](
            items=["a"], total=50, page=3, page_size=20, has_more=False
        )
